...
export type ListCitiesQuery = {
  __typename?: "Query";
  listCities: Array<{ __typename?: "City"; id?: number | null; name: string; country: string }>;
};
...
export type FindCityQuery = {
  __typename?: "Query";
  findCity?: { __typename?: "City"; id?: number | null; name: string; country: string } | null;
};
...
export type SaveCityMutation = {
  __typename?: "Mutation";
  saveCity: { __typename?: "City"; id?: number | null; name: string; country: string };
};
...
export type SavePersonMutation = {
  __typename?: "Mutation";
  savePerson: {
    __typename?: "Person";
    id?: number | null;
...
export class ListAddressesGQL extends Apollo.Query<
  ListAddressesQuery,
...
export class SaveAddressGQL extends Apollo.Mutation<
  SaveAddressMutation,
...
export class DeleteCityGQL extends Apollo.Mutation<
  DeleteCityMutation,
...
export class SavePersonGQL extends Apollo.Mutation<
  SavePersonMutation,
  SavePersonMutationVariables
> {
